...
[Dialogue Mode](https://obsidian.md/plugins?id=dialogue-mode) By _Patrick Chiang_
...
[Local REST API v2.4.3](https://github.com/coddingtonbear/obsidian-local-rest-api/releases/tag/2.4.3) By _Adam Coddington_
