---
uid: 20240128031100
title: Obsidian 样式 -tabbed Callout
tags: [obsidian, callout, tab]
description: 
author: Huajin
type: other
draft: false
editable: false
modified: 20240128031331
---

# Obsidian 样式 -tabbed Callout

## 效果

![Callout styling - Tabbed callout.gif](https://cdn.pkmer.cn/images/Callout%20styling%20-%20Tabbed%20callout.gif!pkmer)

## 用法示例

可以在安装好 css 之后直接复制粘贴查看效果，格式模仿下面这个样式即可
