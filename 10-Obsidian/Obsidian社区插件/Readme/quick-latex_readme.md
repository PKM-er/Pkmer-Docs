...
![自动进入数学模式](https://cdn.pkmer.cn/covers/quick-latex_1_0.gif!pkmer)
...
![自动放大括号](https://cdn.pkmer.cn/covers/quick-latex_1_1.gif!pkmer)
...
![自动括起上标](https://cdn.pkmer.cn/covers/quick-latex_1_2.gif!pkmer)
...
![自动分数](https://cdn.pkmer.cn/covers/quick-latex_1_3.gif!pkmer)

* **提示 1：** 将分数表达式括在圆括号 () 中有助于系统识别分数的边界。

![自动分数 1](https://cdn.pkmer.cn/covers/quick-latex_1_4.gif!pkmer)

* **提示 2：** 在分数前面加上**空格**表示分数的开始。对于一系列分数特别有用！

![自动分数 2](https://cdn.pkmer.cn/covers/quick-latex_1_5.gif!pkmer)

* **提示 3：** 对于较长的分子或分母表达式（特别是当表达式中有可能触发分数替换的空格时），请将表达式括在圆括号**()**中。

![自动分数 3](https://cdn.pkmer.cn/covers/quick-latex_1_6.gif!pkmer)
...
![添加对齐块](https://cdn.pkmer.cn/covers/quick-latex_1_7.gif!pkmer)
...
![添加矩阵块](https://cdn.pkmer.cn/covers/quick-latex_1_8.gif!pkmer)
