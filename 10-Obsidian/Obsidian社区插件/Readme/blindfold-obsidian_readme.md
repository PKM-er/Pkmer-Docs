...
Blindfold旨在通过将文本放在一个*通常折叠*的部分中，将不必要的文本部分从主屏幕中隐藏起来。
可以使用一个按钮来切换显示文本。我打算用它来隐藏丑陋的数学证明，所以它支持LaTeX。
...
请注意，您可以在此代码块中使用任何Obsidian函数，例如 <img width="724" alt="Screenshot 2566-05-23 at 23 25 50" src="https://github.com/vzsky/blindfold-obsidian/assets/20735983/32045b73-d53d-44b9-9f0d-6fb653fb4c45">
将创建以下内容
