...
# Obsidian的Markdown美化工具

尝试修复和重新格式化丑陋的Markdown，并添加诸如“修改日期”等内容。
...
从[GitHub发布页面](https://github.com/cristianvasquez/obsidian-prettify/releases)下载zip压缩包。
...
初始版本，第一次尝试使用Obsidian和插件。没有设置，只有最少的功能。

## 免责声明

该插件按原样提供，并专注于我在Linux上使用Obsidian的个人需求。因此，它并未在所有操作系统和Obsidian的功能上进行全面测试。
