...
> - 插件说明：使用Obsidian作为Github问题编辑器，其中的逻辑取自Git
...
使用Obsidian作为Github问题编辑器，其中的逻辑取自Git
...
# GitHobs 🦤
### 📝 在Obsidian中使用Github问题编辑器！

一个简单的插件，可以直接从Obsidian中创建Github问题，具有Git逻辑。 <br>
友好地使用： 
- 🔄 **fetch**
- ⬇️ **pull**
- ⬆️ **push**
...
- 从[发布页面](https://github.com/GabAlpha/obsidian-githobs/releases/latest/)下载：
	...
	- **manifest.json**
    - **styles.css**  
- 在Obsidian vaults的 **.obsidian/plugins/** 文件夹中，创建 **`githobs`** 文件夹
- 将这3个文件粘贴到这里
### 🏪 浏览社区插件
> [!NOTE]
...
在**设置**页面下，您需要插入以下信息：
1. 一个有效的**GitHub令牌**（链接至[创建一个](https://github.com/settings/tokens)）<br>
