...
> - 插件作者：Zachatoo
> - 插件说明：在Obsidian Canvas中发送一张卡片，以便在所有其他卡片之后。
...
在Obsidian Canvas中发送一张卡片，以便在所有其他卡片之后。
...
将Obsidian Canvas中的卡片发送到其他所有卡片的后面。
...
您可以使用[BRAT](https://github.com/TfTHacker/obsidian42-brat) Obsidian插件手动安装。有关该插件的通用安装说明，请参阅该插件的文档。
