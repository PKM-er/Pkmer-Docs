...
# Obsidian 插件：【Readme】Icon Shortcodes
...
![custom-icon-buttons](https://cdn.pkmer.cn/covers/obsidian-icon-shortcodes_1_1.png!pkmer)

![custom-icon-backup-pack-button](https://cdn.pkmer.cn/covers/obsidian-icon-shortcodes_1_2.png!pkmer)
