...
您可以从Obsidian编辑器中创建和编辑Tistory上的帖子。
...
如果想要指定快捷键，请在Obsidian设置>快捷键中找到"Tistory: Publish to Tistory"并设置所需的快捷键。
