...
title: Obsidian 插件：【Readme】Reminder
...
> - 插件分类：['任务管理', '日期相关', 'obsidian插件', 'readme']
...
您可以使用以下格式为TODO列表项[设置提醒](https://obsidian-reminder.cf/guide/set-reminders.html)。
...
- 移动设备上的通知（Android/iOS）
  - 由于Obsidian不提供此功能，因此移动设备上的系统通知不可用。
