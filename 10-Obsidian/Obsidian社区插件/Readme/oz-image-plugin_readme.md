...
> - 插件作者：Ozan Tellioglu
> - 插件说明：为笔记编辑器中添加图片查看器，查看图像、引用、iFrame和PDF文件，无需切换到预览模式。
> - 插件分类：['界面相关', '图片', 'PDF', 'obsidian插件', 'readme']
...
为笔记编辑器中添加图片查看器，查看图像、引用、iFrame和PDF文件，无需切换到预览模式。
...
## 📕 将Wikilink转换为Markdown和将Markdown转换为Wikilink

插件的链接转换功能已经移至[Obsidian Link Converter Plugin](https://github.com/ozntel/obsidian-link-converter)，并增加了许多额外的功能。您可以从Community Plugins中下载。
