...
- [[lapel]]：在标题旁边显示标题等级
- [[number-headings-obsidian]]：给笔记中的标题自动编号，以及动态目录
- [[obsidian-title-serial-number-plugin]]：通过触发命令给标题进行自动编号
...
- [[pixel-perfect-image]]：简单实用的图片编辑工具
...
- [[checkbox-autochecker-obsidian]]：嵌套任务关联工具，自动帮你完成子任务
...
- [[prozen]]：禅模式启动！
- [[quick-peek-sidebar]]：根据光标感应展开和收起侧边栏
- [[about-blank]]：自定义增强 Obsidian 空白页
...
- [[related-notes-by-tag]]：在侧边栏显示与当前激活笔记有相同标签的笔记列表
...
- [[zettelkasten-navigation]]：可视化和导航一个卢曼风格的笔记库
- [[d3-tagvis]]：把你的标签以可定制的旭日图形式直观呈现出来
...
- [[browser-history]]：打通你的浏览器浏览历史到 Obsidian
- [[tenki]]：一个简单的天气显示插件
...
- [[auto-tag]]：基于 AI 来为笔记生成标签
- [[memory-game]]：这是一个为 Obsidian 设计的注意力训练插件，包含多种认知训练游戏，帮助用户提高注意力集中度、反应速度和认知灵活性。
