...
- [[文档属性视图]]：增加侧边栏视图，你可以用它们来管理属性
## 社区插件

- [[Obsidian社区插件]]：Obsidian 社区插件分类合集
...
- [[Umi-OCR 本地图片识别并批量转换]]
- [[Syncthing]]：点对点同步并版本控制 Obsidian 库
- [[Pandoc学术指南]]
- [[Omnivore]]：免费开源可自建的稍候读，RSS 服务，可与 Obsidian 同步
