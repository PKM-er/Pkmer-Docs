...
- 提高社区知名度：关注 [微信订阅号](https://mp.weixin.qq.com/s/UsJhrOi8hYCy94xEsJHOCQ)、[PKMer • 小红书](https://www.xiaohongshu.com/user/profile/648133be0000000025037d80) 、B 站：[PKMer-哔哩哔哩](https://space.bilibili.com/489501986)、[知乎账号](https://www.zhihu.com/people/pkmer)
...
- 初衷：
	- PKMer 针对一些产品和服务建立早鸟群、交流群。
	- 早鸟群、交流群都是为了构建良好的通道，希望给通过开发者、作者和愿意更加深入参加社区工作的同学，构建更快捷、友善交流知识的环境，帮助作者、开发者、作者更快定位问题和改善产品。
	- 早鸟群：这是致敬了 岩田聪老师的 Direct 理念，但是否适合长期做为社区的常驻项目，会随着社区发展来观测
- 正向案例：
	- 群里发送你觉得对大家优质有帮助的 pkmer 链接
	- 积极推荐好的插件和作者，但是社区还未关注到
- 反面案例
	...
	- 行为举例 3：在不清楚原因的情况下，将发现的问题归结于 社区 或者 社区服务、产品
