...
是的，我处理网络文章的过程是低效的，但我很少阅读网络文章。如果我更多地在网上阅读，我可能会使用 Pocket，并让 Readwise 来管理这些重点。我已经开始尝试使用 [ePub.press](https://epub.press/) 在我的 Kindle 上阅读网络文章，但为了获得重点内容，我必须把我的 Kindle 连接到我的电脑上以挖掘它们。
