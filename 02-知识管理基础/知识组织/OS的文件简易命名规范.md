...
可以是数字序号、字母和数字组合、大的分类；不常用，主要目的是为文件进行手动排序。这里有很多成熟的方法方法论，比如 《杜威十进制法》，或者我们介绍过的《[[Johnny.Decimal 一切源于数字的管理系统]]》
...
当然你也可以参考 [[Johnny.Decimal 一切源于数字的管理系统]]
