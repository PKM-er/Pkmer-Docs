...
![](Pasted%20image%2020230525124727.png)

点击该图标，就会弹出一个与下图类似的对话框：

![](Pasted%20image%2020230525124749.png)

然后点击**加号**，将会显示定义具体规则的对话框：

![](Pasted%20image%2020230525124804.png)
...
![](Pasted%20image%2020230525124825.png)
...
![](Pasted%20image%2020230525124844.png)

插件的设置暂时只有三个。

第一个设置是调整在编辑窗口时点击右键的命令菜单中能够显示的规则集条数。

![](Pasted%20image%2020230525124902.png)

第二个设置是调整在命令窗口能够显示的规则集条数。

![](Pasted%20image%2020230525124911.png)
