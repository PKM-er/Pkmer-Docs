...
- 如若这个词**拓展性强**，用法大有可讲，那就在「生词本」文件夹下新建一篇笔记，将字典上查到的释义记录到这篇笔记中，再在单词笔记与试卷阅读之间建立双链，这样以后复习到这里，鼠标移动到阅读文章中该单词的双链上，即可查看之前记录的单词笔记（如需在预览中直接编辑，可以借助**Hover Editor**插件），顺滑得就像点读笔一样～ ![|500](assets/我用Ob学英语思路整理.assets/image-20230518005810655.png)
...
![|500](assets/我用Ob学英语思路整理.assets/image-20230520215622889.png)
...
- 在文中插入三个字段，要求与文章保持如下位置结构：`^^^article` (回车)<文章>(回车) `^^^words` (回车) `^^^notes`。![|500](assets/我用Ob学英语思路整理.assets/image-20230518001814510.png)
...
![](assets/我用Ob学英语思路整理.assets/image-20230305235231672.png)
 ![](assets/我用Ob学英语思路整理.assets/image-20230305235329866.png)

除此之外，还有一个进阶用法。如果你觉得单词卡片盒的释义暴露在外太过显眼，随便一瞟就可以看到答案起不到复习的作用，可以结合 **Blue Topaz** 主题的「涂黑」的效果，将答案部分遮盖起来，等到鼠标移动到遮盖部分时才会显示内容。

![](assets/我用Ob学英语思路整理.assets/image-20230306001517263.png)

![](assets/我用Ob学英语思路整理.assets/image-20230306001533087.png)
...
![|200](../image-20230319175125361.png)
...
![](../image-20230319174350574.png)![](../image-20230319174551583.png)
...
![|500](assets/我用Ob学英语思路整理.assets/image-20230518183207669.png)
...
![|500](assets/我用Ob学英语思路整理.assets/image-20230518184351673.png)

![|500](assets/我用Ob学英语思路整理.assets/image-20230518012042886.png)
